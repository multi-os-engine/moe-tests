...
#define __EXTERN extern "C" __attribute__((visibility("default")))

__EXTERN jobject Java_dalvik_system_JniTest_returnThis(JNIEnv*, jobject obj) {
  return obj;
}

__EXTERN jclass Java_dalvik_system_JniTest_returnClass(JNIEnv*, jclass klass) {
  return klass;
}

__EXTERN jobject Java_dalvik_system_JniTest_returnObjectArgFrom16(
...
__EXTERN jboolean Java_dalvik_system_JniTest_returnBooleanArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jchar Java_dalvik_system_JniTest_returnCharArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jbyte Java_dalvik_system_JniTest_returnByteArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jshort Java_dalvik_system_JniTest_returnShortArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jint Java_dalvik_system_JniTest_returnIntArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jlong Java_dalvik_system_JniTest_returnLongArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jfloat Java_dalvik_system_JniTest_returnFloatArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jdouble Java_dalvik_system_JniTest_returnDoubleArgFrom16(
    JNIEnv*, jobject, int arg_no,
...
__EXTERN jclass Java_dalvik_system_JniTest_envGetSuperclass(
