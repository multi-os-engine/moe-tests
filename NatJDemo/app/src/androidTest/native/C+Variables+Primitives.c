...
#import "C+Variables+Primitives.h"
...
void NGPrepareVariablesWithPrimitivesTest() {
    kNGBoolValues = malloc(5 * sizeof(bool));
    kNGByteValues = malloc(5 * sizeof(char));
    kNGShortValues = malloc(5 * sizeof(short));
    kNGCharValues = malloc(5 * sizeof(unichar));
    kNGIntValues = malloc(5 * sizeof(int));
    kNGLongValues = malloc(5 * sizeof(long long));
    kNGFloatValues = malloc(5 * sizeof(float));
    kNGDoubleValues = malloc(5 * sizeof(double));
